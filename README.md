...
1. Инициализация оплаты
    ...
    **Параметры:**
    ...
    | orderDescription 	| string  	| Описание платежа (выводится в поле описания платежа и в назначении платежа)                                        	| null                  	| Нет        	| 2.0              	|
...
## Примеры
* [Пример реализации на языке php](https://github.com/CommerceBankTajikistan/CBTPay/tree/master/php "Пример реализации на языке php")

## Изменения
* Версия 2.4.1 (2020/06/04)
    * Исправление ошибок
    * Улучшение кода
